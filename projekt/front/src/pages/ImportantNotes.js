...
function ImportantNotes() {
   ...
   const addNewImportantNote = () => {
      ...
      axios.post(`${process.env.REACT_APP_BACKEND_URL}/important-notes`, newImportantNote)
      .then(() => {
         alert("Success")
      })
   }
   ...
   const deleteImportantNote = (id) => {
      axios.delete(`${process.env.REACT_APP_BACKEND_URL}/important-notes/${id}`)
      .then(() => {
   ...
   useEffect(() => {
      axios.get(`${process.env.REACT_APP_BACKEND_URL}/important-notes`)
      .then((response) => {
